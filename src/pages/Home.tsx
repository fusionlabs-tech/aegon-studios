...
function StatsSection() {
  ...
  return (
    <section ref={containerRef} className="py-32 bg-secondary/20 relative border-y border-border">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-8">
          {[
            ...
            >
              ...
              <p className="opacity-40 group-hover:opacity-60 transition-opacity leading-relaxed">
                {stat.desc}
              </p>
            </motion.div>
          ))}
    ...
    <section className="py-40 bg-background relative overflow-hidden">
      <div className="container mx-auto px-6">
        <div className="grid lg:grid-cols-2 gap-24 items-center">
            ...
            <div className="space-y-12">
              {[
                ...
                <motion.div 
                  ...
                  className="group cursor-pointer border-l border-foreground/10 pl-8 hover:border-foreground transition-colors"
                >
                  <h3 className="text-3xl font-bold mb-4 group-hover:translate-x-4 transition-transform duration-500">{service.title}</h3>
                  <p className="opacity-40 group-hover:opacity-70 transition-opacity leading-relaxed max-w-md">
                    {service.desc}
                  </p>
                </motion.div>
              ))}
          ...
          <div className="relative aspect-[4/5] bg-card group overflow-hidden">
             <img 
