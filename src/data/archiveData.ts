...
export const archiveData: ArchiveItem[] = [
 {
  id: 1,
  title: 'Guinness EMOB 2019',
  category: 'Photography',
  image: '/events/gemob/IMG_2481.jpg',
  coverImage: '/events/gemob/IMG_2615-3.JPG',
  description:
   'A striking fashion photography campaign that captured the essence of luxury streetwear in urban landscapes.',
  longDescription:
  ...
  credits: {
   Director: 'Cyrus Agbo',
   Photography: 'Cyrus Agbo',
   Styling: 'Sarah Rose',
   Location: 'Victoria Island, Lagos',
  },
  gallery: [
   '/events/gemob/IMG_2615-3.JPG',
   '/events/gemob/IMG_2789.JPG',
   '/events/gemob/IMG_2878-2.JPG',
   '/events/gemob/IMG_3112-3.JPG',
   '/events/gemob/IMG_3166.JPG',
  //  '/events/gemob/IMG_3177.JPG',
  ],
 },
 {
  id: 2,
  ...
  coverImage: '/images/tech_launch.png',
  description:
   'Cinematic commercial video production showcasing next-generation technology with stunning visual storytelling.',
  longDescription:
 ...
 },
 {
  ...
  coverImage: '/images/event_summit.png',
  description:
   'Comprehensive event coverage capturing the energy and insights of industry leaders.',
  longDescription:
 ...
 },
 {
  ...
  coverImage: '/images/podcast_setup.png',
  description:
   'Professional multi-camera podcast production bringing intimate conversations to life.',
  longDescription:
 ...
 },
 {
  ...
  coverImage: '/images/luxury_car.png',
  description:
   'Complete brand visual identity development showcasing automotive excellence.',
  longDescription:
 ...
 },
 {
  ...
  coverImage: '/images/studio_session.png',
  description:
   'A deep dive into experimental studio lighting and minimalist composition.',
  longDescription:
 ...
 },
 {
  ...
  coverImage: '/images/urban_nights.png',
  description:
   'A neon-drenched visual journey through the electronic music scene.',
  longDescription:
 ...
 // Extra data for pagination
 {
  ...
  longDescription:
   'A high-energy editorial shoot exploring the intersection of traditional Japanese aesthetics and futuristic cyber-culture.',
  client: 'Moda Future',
  year: '2022',
 ...
 },
 {
  ...
  longDescription:
   'Exploring how VR and AR are reshaping our understanding of physical space and social interaction.',
  client: 'Meta Labs',
  year: '2022',
 ...
 },
 {
  ...
  longDescription:
   'Capturing the intricate details of custom marble, hand-woven textiles, and bespoke lighting in luxury living spaces.',
 ...
 },
 {
  ...
  longDescription:
   'A monumental task involving over 50 hours of live-streamed content and a massive archive of visual assets.',
 ...
 },
 {
  ...
  longDescription:
   'Capturing the raw energy of live musical performance in a controlled studio environment.',
 ...
 },
 {
  ...
  longDescription:
   'Modernizing a 100-year-old brand while preserving its mechanical soul and historical authority.',
  client: 'Horology Co.',
  year: '2020',
