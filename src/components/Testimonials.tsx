    ...
    <>
      ...
      >
        <div className="sticky top-0 h-screen flex flex-col justify-center py-20">
          <div className="max-w-7xl mx-auto px-6 mb-8">
            ...
            >
              <div className="flex items-center justify-center gap-2 md:gap-3 mb-4">
                <Star weight="fill" size={24} className="opacity-40" />
                <Star weight="fill" size={24} className="opacity-40" />
                <Star weight="fill" size={24} className="opacity-40" />
                <Star weight="fill" size={24} className="opacity-40" />
                <Star weight="fill" size={24} className="opacity-40" />
              </div>
              <h3 className="text-[clamp(2.5rem,6vw,5rem)] leading-none font-bold tracking-tight font-display mb-4">
                CLIENT LOVE
              </h3>
              <p className="opacity-40 text-base md:text-xl lg:text-2xl max-w-3xl mx-auto leading-relaxed">
                ...
                >
                  <Card className="h-full border-2 border-border bg-card hover:border-foreground/20 transition-all duration-300 hover:shadow-2xl group">
                    <CardContent className="p-8 md:p-10 flex flex-col h-full">
                      <div className="mb-6">
                        <Quotes weight="fill" size={48} className="opacity-10 group-hover:opacity-20 transition-opacity" />
                      </div>

                      <div className="flex gap-1 mb-6">
                        {Array.from({ length: testimonial.rating }).map((_, i) => (
                          <Star key={i} weight="fill" size={20} className="opacity-60" />
                        ))}
                      </div>

                      <p className="text-lg md:text-xl leading-relaxed mb-8 flex-grow italic opacity-80">
                        "{testimonial.content}"
                      </p>

                      <div className="flex items-center gap-4 pt-6 border-t border-border">
                        <Avatar className="w-14 h-14 md:w-16 md:h-16 ring-1 ring-border">
                        ...
                        <div>
                          ...
                          <div className="opacity-40 text-xs md:text-sm font-bold tracking-wider uppercase">
                            {testimonial.company}
                          </div>
                        </div>
                      </div>
          ...
          >
            <p className="opacity-20 text-xs md:text-sm font-bold tracking-[0.3em] uppercase">
