      ...
      >
        <div className="container mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            <Link to="/" className="text-xl font-bold tracking-[0.2em] font-display flex items-center gap-2">
              <div className="w-8 h-8 bg-foreground flex items-center justify-center text-background text-sm transition-colors duration-500">A</div>
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex justify-between items-center mb-16">
               <span className="font-display font-bold tracking-widest text-xl">MENU</span>
            ...
            <div className="mt-auto grid grid-cols-2 gap-8 border-t border-white/10 pt-12">
              <div>
                <p className="text-[10px] font-bold tracking-widest opacity-30 uppercase mb-4">Email</p>
