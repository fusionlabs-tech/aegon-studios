...
export function Contact({ showHeader = true }: ContactProps) {
  ...
  return (
    <section id="contact" className={`relative bg-background overflow-hidden border-t border-border ${showHeader ? 'py-24 md:py-32' : 'py-0'}`}>
      {showHeader && (
        <>
          {/* Background elements */}
      ...
      <div className={`${showHeader ? 'mt-32 border-t pt-12' : 'py-12 border-t'} text-center opacity-20 text-sm border-border`}>
